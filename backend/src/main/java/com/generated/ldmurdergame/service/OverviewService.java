...
public class OverviewService {
  ...
  public OverviewService(MemberLevelService memberLevelService) {
    this.memberLevelService = memberLevelService;
  }

  public OverviewResponse getOverview() {
    MemberLevelOverview memberLevel = memberLevelService.getOverview();
    return new OverviewResponse(
      ...
      List.of(new FeatureItem(1, "剧本库与DM管理", "录入剧本信息（名称、类型、难度、时长、人数、主持人DM要求），上传剧本封面与简介，关联专属DM主持人，支持按标签筛选与搜索。", "已上线", "88%"),
        ...
        new FeatureItem(4, "会员积分与等级体系", "注册会员消费积累积分，设置等级规则（如青铜/白银/黄金/钻石），不同等级享受折扣与优先拼车位权益，积分可兑换周边或抵扣费用。", "已上线", "5 级"),
      ...
      List.of(new OperationRecord("ldmurdergame-1", "剧本库与DM管理", "运营组", "已上线", "88%", "高"),
        ...
        new OperationRecord("ldmurdergame-4", "会员积分与等级体系", "财务组", "已上线", "5 级", "高"),
